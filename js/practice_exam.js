// Stats tracking for Practice Exam (105 questions)
let stats = {
    correct: 0,
    wrong: 0,
    attempted: 0,
    total: 105 // Total questions in practice exam
};
...
function showWelcomeMessage() {
    Swal.fire({
        title: '📊 Welcome to Statistics Practice Test!',
        html: `
            <div style="text-align: left; padding: 10px;">
                ...
                <p>🎯 <strong>Goal:</strong> Master your statistics knowledge</p>
                <p>💡 <strong>Tip:</strong> Look for "Multiple Answers" badges!</p>
            </div>
        `,
        icon: 'info',
        ...
        html: `
            <div style="text-align: left; padding: 10px;">
                ...
                <ul style="list-style-position: inside;">
                    <li><strong>Single Choice:</strong> Select ONE option and click Submit</li>
                    <li><strong>Multiple Choice:</strong> Look for the "Multiple Answers" badge - select ALL correct options</li>
                    <li>Your progress is tracked at the top of the page</li>
                    <li>Green = Correct ✅, Red = Wrong ❌</li>
                    <li>You can scroll back to review your answers</li>
                </ul>
...
function checkMultiAnswer(qNo) {
    ...
    if (!answeredQuestions.has(qNo)) {
        ...
        if (isCorrect) {
            ...
            stats.wrong++;
            const correctArray = questionDiv.dataset.answer.split(",");
            showWrongAnswer(questionDiv, result, correctArray.join(", "), submitBtn);
        }
